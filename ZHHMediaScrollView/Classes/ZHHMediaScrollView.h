...
@class ZHHMediaScrollView;

@protocol ZHHMediaScrollViewDataSource <NSObject>
...
@protocol ZHHMediaScrollViewDelegate <NSObject, UIScrollViewDelegate>
...
- (void)scrollView:(ZHHMediaScrollView *)scrollView didRemoveCell:(ZHHMediaScrollViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath;
...
// 数据源
@property (nonatomic, weak, nullable) id<ZHHMediaScrollViewDataSource> dataSource;

// 代理
@property (nonatomic, weak, nullable) id<ZHHMediaScrollViewDelegate> delegate;
...
// 当前显示的cell
@property (nonatomic, weak, readonly) ZHHMediaScrollViewCell *currentCell;
...
// 获取cell对应的indexPath
- (nullable NSIndexPath *)indexPathForCell:(ZHHMediaScrollViewCell *)cell;

// 获取indexPath对应的cell
- (nullable __kindof ZHHMediaScrollViewCell *)cellForRowAtIndexPath:(NSIndexPath *)indexPath;
...
// 获取可复用的cell
- (__kindof ZHHMediaScrollViewCell *)dequeueReusableCellWithIdentifier:(NSString *)identifier forIndexPath:(nonnull NSIndexPath *)indexPath;
